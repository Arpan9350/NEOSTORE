    ...
    if (err) {
      ...
      let mailOptions = {
        ...
        html: `<!DOCTYPE html>
                ...
                <div>A request has been made to change password.</div>
               <div> To Reset password  OTP for ${otp}</div>
               <div> This OTP is valid for 10 minutes.</div> <br/>
               <div>If you did not make this request, please ignore this. </div>
                </body>
    </html>`,
      };
