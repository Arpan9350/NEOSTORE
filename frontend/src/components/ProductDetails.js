...
export default function ProductDetails() {
  ...
  const chngeRating = (value) => {
    rateProductService({
      value: ((state.product_rating + value)/state.rated_by),
      rated: state.rated_by + 1,
      id: state._id,
  ...
  return (
    <>
      ...
      <div className="container-fluid">
            ...
            <div>
              ...
              <span
                style={{
                  ...
                  height: "15px",
                  width: "30px",
                  background: location.state.color_id.color_name,
                }}
              ></span>
            </div>
            <div>
              ...
              <div className="mt-4">
                <button
                  ...
                  onClick={() => dispatch({ type: "addCart", payload: state })}
                >
                  Add to Cart
                </button>
        ...
        <div className="row">
          <div className="col lg-6 md-6 sm-12 ml-3">
            <img
              src={`images/${location.state.product_subimages[0]}`}
              height="100"
              width="100"
              onClick={() => setIndex(0)}
            />
            <img
              src={`images/${location.state.product_subimages[1]}`}
              height="100"
              width="100"
              className="mx-3"
              onClick={() => setIndex(1)}
            />
            <img
              src={`images/${location.state.product_subimages[2]}`}
              width="100"
              onClick={() => setIndex(2)}
            />
            <img
              src={`images/${location.state.product_subimages[3]}`}
              width="100"
              className="ml-3"
              onClick={() => setIndex(3)}
            />
