            ...
            emailSubscribeService({ email: stateemail })
                .then(res => {
                    if (res.data.err === 0) {
                        ...
                        // navigate("/thankyou", { state: { email: stateemail} })
                        Swal.fire({ 
                            icon: 'success',
    ...
    return (
        <>
            ...
            <div className='col lg-4 md-12 sm-12 mt-2'>
                ...
                <ul style={{listStyle:"none"}} className='mt-3'>
                    <li><a style={{color: "white" }} href='images/arpan.pdf' target="_blank">Terms and Conditions</a></li>
                    <li>Guarantee and Return Policy</li>
                    <li>Contact Us</li>
                    <li>Privacy Policy</li>
                    <li><a style={{color: "white" }} href="https://www.google.com/maps/place/Apollo+Premier/@22.7500177,75.8966811,15z/data=!4m5!3m4!1s0x0:0x5bef82fe270e4409!8m2!3d22.7500177!4d75.8966811" target="_blank">Locate Us</a></li>
                </ul>
            ...
            <div className='col lg-4 md-12 sm-12 mt-2'>
                ...
                <ul style={{listStyle:"none"}} className='mt-3'>
                    ...
                    <li><button className='btn btn-success mt-3' onClick={() =>subscribe()}>Subscribe</button></li>
                </ul>
            </div>
            </div>
            <div className='text-white text-center pb-3'>© 2022 NeoSOFT Technologies All rights reserved | Designed By <span className='font-weight-bold'>Arpan Jain</span></div>
            </div>
        </>
    )
}
