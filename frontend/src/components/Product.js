      ...
      <div className="row">
        <div className="col lg-2 md-4 sm-12 pl-5 mt-5">
          <ul className="nav flex-column">
            <li className="nav-item">
              <button className="nav-link btn w-100" onClick={() => alldata()}>
                All Products
              </button>
            </li>
          </ul>
        ...
        <div className="col-9">
          <div className=" text-right mt-2" >
            Sort By :{" "}
            <StarIcon class="mx-2" style={{fontSize:"30px",height:"25px"}} onClick={() => setSortdata("star")}/>
            <ArrowUpwardIcon
              class="mx-2"
              style={{fontSize:"30px",height:"25px"}}
              onClick={() => setSortdata("assend")}
            />
            <ArrowDownwardIcon
              class="mx-2"
              style={{fontSize:"30px",height:"25px"}}
              onClick={() => setSortdata("desend")}
            />
          </div>
