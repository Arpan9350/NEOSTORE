  ...
  return (
    <div>
      <div className="mt-5 d-flex justify-content-center">
        <Card  className="text-dark my-5" style={{width: "80%" }}>
          <Card.Body>
            <Card.Title className="text-left m-3 mb-4" >
              <h3>Welcome To Your Profile {state.data.firstname} </h3>
            </Card.Title>
            ...
            <Button className="btn btn-secondary" onClick={() => editProfile()}><EditIcon/> Edit</Button>
          </Card.Body>
        </Card>
      </div>
